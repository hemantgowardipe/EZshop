<?php
    ...
    if(isset($_POST['add']))
    {
      ...
      mysqli_query($con,"INSERT INTO product(udate,title,description,photo,price)VALUES('$udate','$title','$description','$photo','$price') ");
...
<div class="container">
    <br><br><br><br><br>
    <div class="well">
      <span class="glyphicon glyphicon-home"> <b>Electronics Product </b></span>
    </div>
