...
<div class="container">
      <br><br><br><br><br>
      <div class="well"><b>Fashion & Clothing</b></div>
      <!-- Search bar start -->
    <div class="container">
      ...
      <table class="table table-hover table-bordered">
          <tbody id="myTable">
            ...
            echo"
              ...
              $search = $_POST['search'];
            $sdata = mysqli_query($con,"SELECT * FROM fashion WHERE title LIKE '%".$search."%'" );
    ...
    <?php 
      $sdata = mysqli_query($con,"SELECT * FROM fashion ORDER BY pid ");
      while($row = mysqli_fetch_assoc($sdata)) {  
    ?>
    ...
    <div class="panel">
      <div class="panel-heading">
        <img src="<?php echo 'admin/fashionimgs/'.$row['photo'] ?>">
      </div>
